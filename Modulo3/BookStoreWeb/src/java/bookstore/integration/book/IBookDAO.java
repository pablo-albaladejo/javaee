...
public interface IBookDAO {
     ...
     *
     * @param ISBN The string which defines a unique Book identifier
     * @return The <code>{@link ITBook}</code> if it is found; <code>null</code>
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<ITBook> getBookByAuthor(String author) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<ITBook> getBookByEditorial(String editorial) throws TransactionException;
}
