...
public interface IBookDAO {
     ...
     */
    boolean NewBook(IBeanBook Book) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<IBeanBook> getAllBooks() throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    IBeanBook getBookByISBN(String ISBN) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<IBeanBook> getBookByTitle(String title) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    boolean ModifyBook(IBeanBook Book) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<IBeanBook> getBookByAuthorID(int authorID) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<IBeanBook> getBookByAuthor(String author) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    List<IBeanBook> getBookByEditorial(String editorial) throws TransactionException;
}
