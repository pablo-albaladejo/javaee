/////////////////////////////////////////////////////////////////////////////////////
Version 8: Se elimina EJB y se sustituye por Web Services (ahora ya no es un proyecto EAR) sino
+BookstoreWS (cliente empresarial): Sustituye al modulo ejb. Contiene todo el modelo de negocio y publica la fachada como servicio web.
 - Hace falta arrancarlo primero que los otros dos.
+ClientBookstoreWS (cliente empresarial): Contiene la interfaz Swing y la calse Test main de prueba de las operaciones.
+WebBookstoreWS (aplicacion web): Contiente el proyecto web (servlets, flitros, etc) de la version anterior

Para adaptar las interfaces a los servicios web, se ha tenido que cambiar el tipo devuelto en la BusinessFacade por dos razones:
- JAX no permite devolver interfaces/clases abstractas
- WS no permite devolver Objetos (sin hacer modificaiones)
- WS no permite devovler nulos.

Por ello, se ha tenido que cambiar:
- Ya no se devuelve interfaces los Beans, sino los propios beans (BookBean en lugar de IBookBean)
- Ya no se devuelve List (clase abstrcta), sino ArrayList (ojo, JPA devuelve vector, hay que hacer conversiones)
- Se han eleminado los ArrayList como valores de retorno de las interfaces de la Facada, y ahora se manejan arrays planos (list[])
- Como no se puede discriminar por valor nulo, ahora un libro no encontrado/no valido es aquel que su ISBN en igual a ""

Por todo lo demas, la version es la misma que la anterior.
/////////////////////////////////////////////////////////////////////////////////////
