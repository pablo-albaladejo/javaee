...
class TransactionManagerImp extends TransactionManager{
    ...
    @Override
    public ArrayList ExecuteNamedQuery(String NamedQuery){
        return this.ExecuteNamedQuery(NamedQuery, new HashMap<String,Object>());
    }
    
    @Override
    public ArrayList ExecuteNamedQuery(String NamedQuery, Map<String, Object> parameters){
        ...
        return new ArrayList((Vector)query.getResultList());
    }
