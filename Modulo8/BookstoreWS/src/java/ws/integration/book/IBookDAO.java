...
public interface IBookDAO {
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<IBookDO> getAllBooks() throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<IBookDO> getBookByTitle(String title) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<IBookDO> getBookByAuthor(String author) throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<String> getAllAuthors() throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<String> getAllEditorials() throws TransactionException;
     ...
     * @throws TransactionException if a DDBB exception occurred
     */
    ArrayList<IBookDO> getBookByEditorial(String editorial) throws TransactionException;
}
